...
export function ContactForm({ dict }: { dict: Dictionary }) {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="mt-10 flex max-w-lg flex-col gap-5 rounded-2xl border border-line bg-surface p-6 sm:p-8 relative overflow-hidden"
    >
      {/* Corner accent */}
      <motion.div
    ...
    <>
      ...
      <div className="hero-glow cinematic-grid border-b border-line overflow-hidden">
        <Container className="py-12 sm:py-20 lg:py-24">
          ...
          <h1 className="font-display text-4xl tracking-tight text-ink sm:text-6xl lg:text-7xl overflow-hidden">
